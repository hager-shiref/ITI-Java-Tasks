...
public class comboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "select1", "select2", "select3", "select4" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jComboBox1.addItem((String) selected);
        jComboBox2.removeItem(selected);
        if(jComboBox2.getItemCount()==0){
            JOptionPane.showMessageDialog(this,"There is no items in ComboBox");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jComboBox2.addItem((String) selected);
